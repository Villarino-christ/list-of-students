            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <span class="navbar-text px-lg-3">
                        <a class="text-primary text-decoration-none nav-link me-3" href="process.php?logout">Logout</a>
                    </span>
                    <?php } else { ?>
                        <span class="navbar-text px-lg-3">
                            <a type="button" class="text-decoration-none text-primary nav-link me-3" aria-current="page" href="login.php">Login</a>
                        </span>
                    <?php } ?>
                    </ul>
                </div>
